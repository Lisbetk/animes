	...
	<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav">
						<li class="active"><a href="#">Animes Accion</a></li>
						<li><a href="#">Animes Romanticos</a></li>
					</ul>
					<form class="navbar-form navbar-right" role="search">
						<div class="form-group">
							<input type="text" class="form-control" placeholder="escribe nombre Anime">
						</div>
						<button type="submit" class="btn btn-default">Buscar</button>
					</form>
					<ul class="nav navbar-nav navbar-right">
						<li><a href="#">Unirme al Grupo</a></li>
						<li class="dropdown">
		...
		<div id="carousel-id" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item">
                        <img data-src="public/imagenes/4.jpg" alt="Second slide" src="public/imagenes/4.jpg">

                    </div>
                    <div class="item">
                        <img data-src="public/imagenes/5.jpg" alt="Second slide" src="public/imagenes/5.jpg">
